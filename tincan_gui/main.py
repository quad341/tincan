...
class MainWindow(QMainWindow):
    ...
    def _apply_capabilities(self, caps: dict) -> None:
        ...
        # call_link_ready: True iff CallController has a bound VoiceCallManager for the
        # iPhone's HFP modem (dialing is actually possible right now) — not SCO/audio
        # link state. Default False (conservative — a false positive here risks a
        # silent dial() RuntimeError, not just a banner).
