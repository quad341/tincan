...
class TestInstallExcepthook:
    ...
    def test_original_excepthook_still_called(self):
        ...
        try:
            ...
            # Patch _show_popup to prevent a blocking QMessageBox when a real
            # QApplication exists (created by other tests' qtbot usage).
            with patch("tincan_gui.debug_log._show_popup"):
